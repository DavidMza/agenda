class UsersController < ApplicationController
  ...
  def new
    @user = User.new
    @unpais = 1 # Predeterminamos, Argentina
    @unaprovincia = 11 # Predeterminamos, Mendoza
  end
  ...
  private
    ...
    def user_params
      params.require(:user).permit(:nombre, :apellido, :email, :activo, :edad, :detalles,  :province_id, :password, :password_confirmation, :admin)
    end
end
